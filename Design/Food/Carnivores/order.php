...
$sql="INSERT INTO order_details VALUES('$firstname1','$lastname1','$emailid1',$phoneno1,$count,'$address1','$productname')";
...
if(!$mail->send()) {
    echo("<script>location.href = 'MSG REDIRECT/msgnotsent.html';</script>");
} else {
	  echo("<script>location.href = 'MSG REDIRECT/msgsent.html';</script>");
}
?>
